...
class MolecularWeightCalculatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function getTestData()
    {
        return [
            ...
            'C15-H13-Cl-N-Na-O3.2H2O' => 15 * 12.0107 + 13 * 1.00794 + 35.453 + 14.0067 + 22.98976928 + 3 * 15.9994 + 2 * (2 * 1.00794 + 15.9994),
            'C15-H13-Cl-N-Na-O3.2H2-O' => 15 * 12.0107 + 13 * 1.00794 + 35.453 + 14.0067 + 22.98976928 + 3 * 15.9994 + 2 * (2 * 1.00794 + 15.9994),
        ];
    }
